              ...
              <div className="relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="mt-6">
                    <p className="text-xs text-white/50 leading-relaxed">
                      ...
                      <Link 
                        ...
                        className="text-nautilus hover:text-white underline font-bold transition-colors"
                      >
                  ...
                  <button
                    ...
                    className="w-full bg-[#372da5] text-white px-8 py-5 rounded-2xl font-black text-lg uppercase italic hover:bg-[#2a2280] transition-all flex items-center justify-center gap-3 mt-8 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <Send size={20} />
