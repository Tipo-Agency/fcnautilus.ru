            ...
            <div>
              ...
              >
                ...
                <div className="mt-6">
                  <p className="text-xs text-white/50 leading-relaxed">
                    ...
                    <Link 
                      to="/policy" 
                      target="_blank"
                      className="text-white hover:text-nautilus underline font-bold transition-colors"
                    >
                ...
                <button
                  ...
                  className="w-full bg-white text-nautilus py-4 rounded-xl font-black text-lg uppercase flex items-center justify-center gap-3 hover:bg-white/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-8"
                >
                  {isSubmittingGift ? 'Отправка...' : 'Получить подарок'} <Send size={20} />
                </button>
              </form>
            </div>
            <div className="relative">
